...
def generate_launch_description():
    ...
    robot_description_mock = Command([
        ...
        PathJoinSubstitution([FindPackageShare("dg5f_s_driver"), "urdf", "dg5f_s_left_mock.xacro"]),
    ])

    robot_description_real = Command([
        PathJoinSubstitution([FindExecutable(name="xacro")]), " ",
        PathJoinSubstitution([FindPackageShare("dg5f_s_driver"), "urdf", "dg5f_s_left_ros2_control.xacro"]),
        " ", "delto_ip:=", delto_ip,
    ...
    srdf_content = Command(["cat ", PathJoinSubstitution([FindPackageShare("dg5f_s_moveit_config"), "srdf", "dg5f_s_left.srdf"])])
    ...
    joint_limits_yaml = load_yaml("dg5f_s_moveit_config", "config/joint_limits.yaml")
    ompl_planning_yaml = load_yaml("dg5f_s_moveit_config", "config/ompl_planning.yaml")
    moveit_controllers_yaml = load_yaml("dg5f_s_moveit_config", "config/moveit_controllers_left.yaml")
    ...
    mock_controllers = PathJoinSubstitution(
        [FindPackageShare("dg5f_s_driver"), "config", "dg5f_s_left_mock_controller.yaml"])
    real_controllers = PathJoinSubstitution(
        [FindPackageShare("dg5f_s_driver"), "config", "dg5f_s_left_effort_controller.yaml"])
    ...
    rviz_config = PathJoinSubstitution([FindPackageShare("dg5f_s_moveit_config"), "config", "dg5f_s_left_moveit.rviz"])
