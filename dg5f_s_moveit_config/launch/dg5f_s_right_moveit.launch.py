...
def generate_launch_description():
    ...
    robot_description_mock = Command([
        ...
        PathJoinSubstitution([FindPackageShare("dg5f_s_driver"), "urdf", "dg5f_s_right_mock.xacro"]),
    ])

    robot_description_real = Command([
        PathJoinSubstitution([FindExecutable(name="xacro")]), " ",
        PathJoinSubstitution([FindPackageShare("dg5f_s_driver"), "urdf", "dg5f_s_right_ros2_control.xacro"]),
        " ", "delto_ip:=", delto_ip,
    ...
    srdf_content = Command(["cat ", PathJoinSubstitution([FindPackageShare("dg5f_s_moveit_config"), "srdf", "dg5f_s_right.srdf"])])
    ...
    moveit_controllers_yaml = load_yaml("dg5f_s_moveit_config", "config/moveit_controllers.yaml")
    ...
    rviz_config = PathJoinSubstitution([FindPackageShare("dg5f_s_moveit_config"), "config", "dg5f_s_right_moveit.rviz"])
