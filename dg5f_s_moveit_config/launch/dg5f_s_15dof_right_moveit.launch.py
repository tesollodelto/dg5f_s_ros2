...
def generate_launch_description():
    ...
    ns = "dg5f_s_15dof_right"

    robot_description_mock = Command([
        PathJoinSubstitution([FindExecutable(name="xacro")]), " ",
        PathJoinSubstitution([FindPackageShare("dg5f_s_driver"), "urdf", "dg5f_s_15dof_right_mock.xacro"]),
    ])

    robot_description_real = Command([
        PathJoinSubstitution([FindExecutable(name="xacro")]), " ",
        PathJoinSubstitution([FindPackageShare("dg5f_s_driver"), "urdf", "dg5f_s_15dof_right_ros2_control.xacro"]),
        " ", "delto_ip:=", delto_ip,
    ...
    mock_controllers = PathJoinSubstitution(
        [FindPackageShare("dg5f_s_driver"), "config", "dg5f_s_15dof_right_mock_controller.yaml"])
    real_controllers = PathJoinSubstitution(
        [FindPackageShare("dg5f_s_driver"), "config", "dg5f_s_15dof_right_effort_controller.yaml"])
    ...
    controller_spawner = Node(
        package="controller_manager", executable="spawner",
        arguments=["dg5f_s_15dof_right_controller", "-c", "/" + ns + "/controller_manager"],
        output="screen")
    ...
    rviz_config = PathJoinSubstitution([FindPackageShare("dg5f_s_moveit_config"), "config", "dg5f_s_15dof_right_moveit.rviz"])
