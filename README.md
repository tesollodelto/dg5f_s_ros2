...
```bash
mkdir -p ~/ros2_ws/src && cd ~/ros2_ws/src
git clone https://github.com/tesollodelto/dg5f_s_ros2.git
...
colcon build --symlink-install --packages-up-to dg5f_s_description dg5f_s_driver dg5f_s_gz dg5f_s_moveit_config
source install/setup.bash
```

> **Do not** use `--packages-select dg5f_s_description dg5f_s_driver dg5f_s_gz dg5f_s_moveit_config`. It skips `delto_hardware` and
