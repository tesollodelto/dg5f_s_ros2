...
def generate_launch_description():
    ...
    robot_description_content1 = Command([
        ...
        " ",
        PathJoinSubstitution([FindPackageShare("dg5f_s_gz"), "urdf", "dg5f_s_15dof_left_gz.xacro"]),
    ])
    ...
    robot_controllers = PathJoinSubstitution([
        FindPackageShare("dg5f_s_gz"), "config", "dg5f_s_15dof_left_gz_controller.yaml",
    ])
